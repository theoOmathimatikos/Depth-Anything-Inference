...
def process_images(model, dataset, in_dir="Data/Run", out_dir="Depth_Model/Results",
    ...
    for image_path in tqdm(os.listdir(input_dir), desc="Processing Images"):
        ...
        if True:
            ...
            ### TODO. Check memory usage during inference
...
if __name__ == '__main__':
    ...
    model_path = '/home/thodoris-lymperopoulos/Documents/2. Projects/2. Seaquest Projects/2_fouling_roughness_estim/Depth_Anything'
    parser.add_argument("-p", "--pretrained_resource", type=str, default=model_path+'/metric_depth/checkpoints/depth_anything_metric_depth_outdoor.pt', help="Pretrained resource to use for fetching weights.")

    args = parser.parse_args()
    main(args.model, args.pretrained_resource, 
         in_dir="custom_dataset/Images",
         out_dir="custom_dataset/depth")
