...
class DPT_DINOv2(nn.Module):
    ...
    def __init__(self, encoder='vitl', features=256, use_bn=False, out_channels=[256, 512, 1024, 1024], use_clstoken=False):
        ...
        # load_dir = os.getcwd() + "/Depth_Anything" 
        load_dir = "kaggle/input/depth_anything_torchhub/pytorch/default/1" 

        self.pretrained = torch.hub.load(load_dir + '/torchhub/facebookresearch_dinov2_main', 
